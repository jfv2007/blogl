<div class="form-group">
    ...
    {!! Form::text('id_usuario', $user_id, ['class' => 'form-control', 'readonly' => 'true']) !!}

     {!! Form::label('id_tag18s','ID de tag')!!}
    {!! Form::text('id_tag18s', $id_tag18s, ['class' => 'form-control', 'readonly' => 'true']) !!}
    ...
    {!! Form::text('descripcion_falla',null,['class' => 'form-control', 'placeholder'=>'Ingrese la descripcion de la falla']) !!}

    {!! Form::label('id_sfallas','Status Falla') !!}
    {!! Form::select('id_sfallas',$sfallas, null ,['class'=>'form-control']) !!}

    {!! Form::label('turno','Turno')!!}
    {!! Form::text('turno',null,['class'=>'form-control', 'placeholder'=>'Ingrese el turno de la falla']) !!}
